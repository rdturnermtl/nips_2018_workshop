...
The supported performance curves are ROC, precision-recall, and precision-recall-gain. % TODO ref
...
% TODO insert eqn for each error bar
...
The error bars are consistent with each other in the sense that: 
...
% refs: proper scoring, AUPRG, bernstein, sklearn bug
