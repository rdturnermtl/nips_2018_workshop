...
Non-probabilistic methods are still usable within this framework by ``pipelining'' with a \emph{calibrator}~\citep{Platt1999,Kull2017}, some of which are already available in sklearn.
